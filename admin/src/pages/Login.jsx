        ...
        <div className=" flex justify-between mx-[250px]  my-32">
            <div className=" my-20">
                ...
                <form onSubmit={login} className="">
                    ...
                    <input onChange={(e)=> setEmail(e.target.value) } value={email} className=" w-[330px] border rounded-lg px-2 py-2 mt-4   " type="email" name="" id="" placeholder="hannah.green@test.com" />
                    </div>
                    <label className=" mt-4 text-lg font-bold block">Password</label>
                    <input onChange={(e)=> setPassword(e.target.value) } value={password} className=" w-[330px] border rounded-lg px-2 py-2 mt-4" type="password" name="" id="" placeholder="enter your password" />
                <div className=" mt-2 text-main cursor-pointer" onClick={()=> navigate(`/forget-password`)}>
                  Forget Password
                </div>
