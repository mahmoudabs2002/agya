        ...
        {postOpen === true ? (
          <div className=" z-[1000] fixed bg-black/40 w-[1490px] h-[110vh] left-0 -top-[4px]  ">
            <div className=" bg-white flex flex-col py-4 px-4 justify-center top-[25%] absolute left-[30%] items-center">
              <form  onSubmit={newPost} className=" relative border-main border p-4">
                <div
                ...
                <textarea onChange={(e)=>setPostText( e.target.value)} className=" border border-black mt-4 resize-none w-[500px] h-32 ">
                  {" "}
                </textarea>
        ...
        <header className="w-full py-3 ">
          <div className=" flex items-center justify-between gap-4">
            ...
            <div className="flex-1 max-w-xl flex items-center gap-2">
              <form onSubmit={()=>navigate(`/article/search?search=${search}`)} className="relative flex-1">
